...
class Product extends CI_Controller
{
    ...
    {
        $data = $this->input->post('data');
        $data = $this->cms_common_string->allow_post($data, ['prd_code','infor', 'prd_name', 'prd_sls', 'prd_edit_price', 'prd_allownegative','prd_image_url', 'prd_origin_price', 'prd_sell_price', 'prd_sell_price2','prd_group_id', 'prd_unit_id', 'prd_vat', 'prd_descriptions', 'display_website', 'prd_new', 'prd_hot', 'prd_highlight']);
