    ...
    <div class="report">
        ...
        <div class="col-md-4">
            <div class="report-box box-blue">
                ...
                <div class="infobox-data">
                    <h3 class="infobox-title">Số đơn bán:</h3>
                    <span
        ...
        <div class="widget widget-blue">
            ...
            <div class="widget-body">
                <div class="row">
                    ...
                    <div class="info col-xs-7"></div>
                    <div class="info col-xs-5 data text-right"></div>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="widget widget-green">
            ...
            <div class="widget-body">
                <div class="row">
                    ...
                    <div
                        class="info col-xs-5 data text-right"><?php echo (isset($data['_sl_product'])) ? $data['_sl_product'] : 0; ?>/<?php echo (isset($data['_sl_manufacture'])) ? $data['_sl_manufacture'] : 0; ?></div>
