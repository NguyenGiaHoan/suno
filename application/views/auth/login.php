<div class="login-container col-md-4 col-md-offset-4" id="login-form">
    <div class="login-frame clearfix">
        <h3 class="heading col-md-10 col-md-offset-1 padd-0" style="text-align:center"><i class="fa fa-lock"></i>Đăng nhập</h3>
        ...
        <div class="col-md-10 col-md-offset-1">
            <form class="form-horizontal login-form frm-sm" method="post" action="">
                ...
                <div class="form-group">
                    <!-- <span style="text-align:center;float:left;width:100%">Hỗ trợ:</span> -->
