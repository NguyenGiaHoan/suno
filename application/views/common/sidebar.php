<div class="sidebar sidebar-fixed hidden-xs hidden-sm hidden-md" id="sidebar">
    <ul class="nav nav-pills nav-list nav-stacked">
	    <?php if (in_array(19, $user['group_permission'])) : ?>
            <!-- <li id="pos"><a href="pos" style="color: white;background-color:#ffb752!important;"><i class="fa fas fa-tachometer"></i>POS</a></li> -->
			<li id="cafe"><a href="cafe" style="color: white;background-color:#ffb752!important;"><i class="fa fas fa-coffee"></i>CAFE</a></li>			
        <?php endif; ?>
