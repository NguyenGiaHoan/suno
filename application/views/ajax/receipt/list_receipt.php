<table class="table table-bordered table-striped">
    ...
    <tr>
        ...
        <th class="text-center">Chứng từ liên quan</th>
        ...
        foreach ($_list_receipt as $key => $item) :
            ...
            <tr>
                ...
                <td class="text-center zoomin">
                    <img height="30"
                         src="public/templates/uploads/<?php echo $item['receipt_image']; ?>">
                </td>
                ...
                <td class="text-center" style="background: #fff;">
                    <i title="In" onclick="cms_print_receipt(5,<?php echo $item['ID'];?>)" class="fa fa-print blue" style="margin-right: 5px;">
                    </i>
                    <?php if($edit_receipt==1) { ?>
                        <i class="fa fa-pencil-square-o" title="Sửa"
                           onclick="cms_edit_receipt(<?php echo $item['ID'] . ',' . $page; ?>)"></i>
                        <?php
                    }
                    ?>
                    <?php if($delete_receipt==1){?>
