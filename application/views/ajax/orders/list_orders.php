<table class="table table-bordered table-striped">
    ...
    <tr>
        ...
        <th class="text-center" style="background-color: #fff;">Tổng SL</th>
        ...
        foreach ($_list_orders as $key => $item) :
            ...
            <tr>
                ...
                <td class="text-center"
                    style="background-color: #F2F2F2;"><?php echo ($item['total_quantity']); ?>
                </td>
                <td class="text-center"
                ...
                <td class="text-center" style="background: #fff;">
                    ...
                    <?php }?>
                    <i title="In" onclick="cms_print_order(2,<?php echo $item['ID']; ?>)"
