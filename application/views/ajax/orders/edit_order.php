<?php 
if(!isset($data['_order']['ID']))
{
    echo '<SCRIPT type="text/javascript"> 
        alert("Không nhận được đơn hàng. Đơn hàng đã hủy");
                    ...
                    foreach ($_list_products as $product): ?>
                        <tr data-id="<?php echo $product['ID'] ?>">
                            ...
                            <td><?php echo $product['prd_name']; ?>
                                <input type="text" class="form-control note_product_order" placeholder="Ghi chú" value="<?php echo $product['note']; ?>">
                            </td>
                            <td class="text-center zoomin"><img height="30"
                                                                src="public/templates/uploads/<?php echo $product['prd_image_url']; ?>">
                            </td>
                            <td class="text-center" style="max-width: 30px;"><input style="max-height: 22px;"
                                                                                    type="text"
                    ...
                    <div class="morder-info" style="padding: 4px;">
                        <div class="tab-contents" style="padding: 8px 6px;">
                            <div class="form-group marg-bot-10 clearfix">
                                ...
                                <div class="col-md-8">
                                    <?php echo !empty(cms_finding_tablebyID($data['_order']['table_id'])) ? cms_finding_tablebyID($data['_order']['table_id'])['table_name'] : 'Pos'; ?>
                                </div>
                            </div>
                            <div class="form-group marg-bot-10 clearfix">
                                <div class="col-md-4 padd-0">
