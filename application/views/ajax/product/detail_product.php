                    ...
                    <div class="row">
                        ...
                        <div>
                            <div class="col-md-6 padd-left-0">
                                ...
                                <div class="col-md-12 padd-0">
                                    <div><?php echo (cms_getNameunitbyID($_detail_product['prd_unit_id']) == 'Chưa có') ? 'Chưa có' : cms_getNameunitbyID($_detail_product['prd_unit_id']); ?></div>
                                </div>
                            </div>
                            <div class="col-md-6 padd-right-0">
                        ...
                        <div class="form-group clearfix">
                            <div class="col-md-6 padd-left-0">
                                ...
                                <div><?php echo $_detail_product['infor']; ?></div>
                            </div>
                            <div class="col-md-6 padd-right-0">
