<table class="table table-bordered table-striped">
    ...
    <tr>
        ...
        <th class="text-center" style="background-color: #fff;">Giá bán lẻ</th>
        <th class="text-center" style="background-color: #fff;">Giá bán sỉ</th>
        ...
        foreach ($data['_list_product'] as $key => $item) : ?>
            <tr>
                ...
                <td class="text-center zoomin">
                    <img height="30"
                         src="public/templates/uploads/<?php echo $item['prd_image_url']; ?>">
                </td>
                <td class="text-center"><?php echo $item['prd_sls']; ?></td>
                <td class="text-right"
                    style="font-weight: bold;"><?php echo number_format($item['prd_sell_price']); ?></td>
                <td class="text-right"
                    style="font-weight: bold;"><?php echo number_format($item['prd_sell_price2']); ?></td>
